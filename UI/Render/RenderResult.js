...
Core.UI.Render.RenderResult = class extends Runtime.CoreStruct{
	...
	assignObject(obj){
		if (obj instanceof Core.UI.Render.RenderResult){
	...
	assignValue(variable_name, value, sender){if(sender==undefined)sender=null;
		if (variable_name == "layout_class")this.__layout_class = Runtime.rtl.convert(value,"string","","");
		else if (variable_name == "view_class")this.__view_class = Runtime.rtl.convert(value,"string","","");
		else if (variable_name == "layout_model")this.__layout_model = Runtime.rtl.convert(value,"Core.UI.Render.LayoutModel",null,"");
		else if (variable_name == "view_model")this.__view_model = Runtime.rtl.convert(value,"Runtime.CoreStruct",null,"");
