...
Core.UI.Events.UserEvent.FocusEvent = class extends Core.UI.Events.UserEvent.UserEvent{
	...
	assignObject(obj){
		if (obj instanceof Core.UI.Events.UserEvent.FocusEvent){
		}
...
Core.UI.Events.UserEvent.FocusEvent.ES6_EVENT_NAME = "focus";