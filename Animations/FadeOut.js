...
if (typeof RuntimeUI.Animations == 'undefined') RuntimeUI.Animations = {};
RuntimeUI.Animations.FadeOut = class extends RuntimeUI.Annotations.ControllerAnnotation{
	/**
	 * Init controller
	 */
	...
	getClassName(){return "RuntimeUI.Animations.FadeOut";}
	static getCurrentClassName(){return "RuntimeUI.Animations.FadeOut";}
	...
	assignObject(obj){
		if (obj instanceof RuntimeUI.Animations.FadeOut){
			this.__speed = obj.__speed;
		}
		super.assignObject(obj);
	}
	assignValue(variable_name, value, sender){if(sender==undefined)sender=null;
		if (variable_name == "speed")this.__speed = Runtime.rtl.convert(value,"int",0,"");
