...
Core.UI.Render.LayoutModel = class extends Runtime.CoreStruct{
	...
	_init(){
		...
		this.__css_vars = new Runtime.Dict();
	...
	assignObject(obj){
		if (obj instanceof Core.UI.Render.LayoutModel){
	...
	assignValue(variable_name, value, sender){if(sender==undefined)sender=null;
		if (variable_name == "title")this.__title = Runtime.rtl.convert(value,"string","","");
		else if (variable_name == "meta_description")this.__meta_description = Runtime.rtl.convert(value,"string","","");
		else if (variable_name == "meta_keywords")this.__meta_keywords = Runtime.rtl.convert(value,"string","","");
		else if (variable_name == "content")this.__content = Runtime.rtl.convert(value,"string","","");
		else if (variable_name == "view")this.__view = Runtime.rtl.convert(value,"string","","");
		else if (variable_name == "model")this.__model = Runtime.rtl.convert(value,"Runtime.CoreStruct",null,"");
		else if (variable_name == "assets")this.__assets = Runtime.rtl.convert(value,"Runtime.Collection",null,"string");
		else if (variable_name == "components")this.__components = Runtime.rtl.convert(value,"Runtime.Collection",null,"string");
		else if (variable_name == "modules")this.__modules = Runtime.rtl.convert(value,"Runtime.Collection",null,"string");
		else if (variable_name == "modules_path")this.__modules_path = Runtime.rtl.convert(value,"Runtime.Collection",null,"string");
		else if (variable_name == "css_vars")this.__css_vars = Runtime.rtl.convert(value,"Runtime.Dict",new Runtime.Dict(),"string");
