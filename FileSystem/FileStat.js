...
Core.FileSystem.FileStat = class extends Core.FileSystem.FileNode{
	...
	assignObject(obj){
		if (obj instanceof Core.FileSystem.FileStat){
	...
	assignValue(variable_name, value, sender){if(sender==undefined)sender=null;
		if (variable_name == "exists")this.__exists = Runtime.rtl.convert(value,"bool",false,"");
		else if (variable_name == "mode")this.__mode = Runtime.rtl.convert(value,"string","","");
		else if (variable_name == "user")this.__user = Runtime.rtl.convert(value,"string","","");
		else if (variable_name == "group")this.__group = Runtime.rtl.convert(value,"string","","");
		else if (variable_name == "size")this.__size = Runtime.rtl.convert(value,"int",0,"");
		else if (variable_name == "atime")this.__atime = Runtime.rtl.convert(value,"int",0,"");
		else if (variable_name == "ctime")this.__ctime = Runtime.rtl.convert(value,"int",0,"");
		else if (variable_name == "mtime")this.__mtime = Runtime.rtl.convert(value,"int",0,"");
		else if (variable_name == "mime")this.__mime = Runtime.rtl.convert(value,"string","","");
		else if (variable_name == "charset")this.__charset = Runtime.rtl.convert(value,"string","","");
		else if (variable_name == "download_url")this.__download_url = Runtime.rtl.convert(value,"string","","");
