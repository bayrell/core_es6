...
Core.UI.Annotations.Event = class extends Core.UI.Annotations.AnnotationEvent{
	/**
	 * OnEvent
	 */
	events(){
	...
	static onEvent(manager, e){
		...
		var f = Runtime.rtl.method(manager, e.annotation.method_name);
		f(e);
	}
	/**
	 * Add Emitter
	...
	assignObject(obj){
		if (obj instanceof Core.UI.Annotations.Event){
