...
if (typeof Core.UI.Animations == 'undefined') Core.UI.Animations = {};
Core.UI.Animations.FadeIn = class extends Core.UI.Annotations.ControllerAnnotation{
	/**
	 * Init controller
	 */
	...
	getClassName(){return "Core.UI.Animations.FadeIn";}
	static getCurrentNamespace(){return "Core.UI.Animations";}
	static getCurrentClassName(){return "Core.UI.Animations.FadeIn";}
	...
	assignObject(obj){
		if (obj instanceof Core.UI.Animations.FadeIn){
