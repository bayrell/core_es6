...
RuntimeUI.Events.CommandEvent = class extends Runtime.CoreEvent{
	/* ======================= Class Init Functions ======================= */
	getClassName(){return "RuntimeUI.Events.CommandEvent";}
	static getCurrentClassName(){return "RuntimeUI.Events.CommandEvent";}
	...
	assignObject(obj){
		if (obj instanceof RuntimeUI.Events.CommandEvent){
