...
Core.FileSystem.FileIOResult = class extends Runtime.CoreStruct{
	...
	assignObject(obj){
		if (obj instanceof Core.FileSystem.FileIOResult){
	...
	assignValue(variable_name, value, sender){if(sender==undefined)sender=null;
		...
		else if (variable_name == "bytes")this.__bytes = Runtime.rtl.convert(value,"Runtime.Collection",null,"mixed");
		else if (variable_name == "offset")this.__offset = Runtime.rtl.convert(value,"int",0,"");
		else if (variable_name == "count")this.__count = Runtime.rtl.convert(value,"int",0,"");
		else if (variable_name == "size")this.__size = Runtime.rtl.convert(value,"int",0,"");
		else if (variable_name == "eof")this.__eof = Runtime.rtl.convert(value,"bool",false,"");
...
Core.FileSystem.FileIOResult.KIND_READ_BINARY = "rb";
Core.FileSystem.FileIOResult.KIND_WRITE_BINARY = "wb";