...
Core.FileSystem.FileNode = class extends Runtime.CoreStruct{
	...
	assignObject(obj){
		if (obj instanceof Core.FileSystem.FileNode){
	...
	assignValue(variable_name, value, sender){if(sender==undefined)sender=null;
		...
		else if (variable_name == "items")this.__items = Runtime.rtl.convert(value,"Runtime.Collection",null,"Core.FileSystem.FileNode");
...
Core.FileSystem.FileNode.KIND_FOLDER = "folder";
Core.FileSystem.FileNode.KIND_SYMLINK = "symlink";
Core.FileSystem.FileNode.KIND_FILE = "file";