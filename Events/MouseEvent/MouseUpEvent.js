...
RuntimeUI.Events.MouseEvent.MouseUpEvent = class extends RuntimeUI.Events.MouseEvent.MouseEvent{
	...
	assignObject(obj){
		if (obj instanceof RuntimeUI.Events.MouseEvent.MouseUpEvent){
		}
...
RuntimeUI.Events.MouseEvent.MouseUpEvent.ES6_EVENT_NAME = "mouseup";